namespace Domain.Dtos.Endereco
{
    ...
    {
        public EnderecoDto(string bairropopular, string cep, string idbairro, string id,
                           string idlogradouro, string idregional, string nomelogradouro,
                           string nomeregional, string numero, string tipologradouro, string wkt,
